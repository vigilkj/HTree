...
public class TTreeWindow extends JFrame implements MouseListener {
	 ...
	 */
	public TTreeWindow(int width, int height) {
		super("TTreeWindow");
	...
	private void reset() {
		...
		if (tree == null) { // tree not created yet
			tree = new TTree(b.width / 2, b.height / 2 + 12, 
	...
	public static void main(String[] args) {
		TTreeWindow htwin = new TTreeWindow(600, 520);
